...
public class HomeActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gso = ((GoogleApiClientAplication) getApplication()).getGoogleSignInOptions();
        mGoogleApiClient = ((GoogleApiClientAplication) getApplication()).getGoogleApiClient(HomeActivity.this, this);
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            String displayedUsername = acct.getDisplayName();
            String userEmail = acct.getEmail();
            String userProfilePhoto = acct.getPhotoUrl().toString();

            Intent googleSignInIntent = new Intent(HomeActivity.this, NavigationActivity.class);
